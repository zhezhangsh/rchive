...
fn0<-paste(RCHIVE_HOME, 'source/script/update/gene.set/UpdateBiosystems.r', sep='/');
fn1<-paste(RCHIVE_HOME, '/source/script/update/gene.set/log/', tm, '_UpdateBiosystems.r' , sep='');
