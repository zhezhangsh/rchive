...
# Parse source files from NCBI BioSystems
path<-paste(RCHIVE_HOME, 'data/gene.set/public/biosystems', sep='/'); # home directory of data
...
# Current version of biosystem
ver<-"ftp://ftp.ncbi.nih.gov/pub/biosystems//biosystems.20150108";
